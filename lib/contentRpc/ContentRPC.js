...
class ContentRPC {
    ...
    handleRuntimeMessage(message, messageSender) {
        if (
            ...
            (this._demandInstanceToken && message.rpcInstanceToken !== this._demandInstanceToken)
        ) {
            return undefined;
        }
     ...
     * The TabContentRPC instance at the other end of the channel must be configured with the same token.
