...
const log = require('../logger')({MODULE: 'CnCServerConnection'});
...
const {handleExtensionLogMessage} = require('./logging');
...
class CnCServerConnection {
    constructor() {
        ...
        this.rpc.notification('logMessage', handleExtensionLogMessage);
...
CnCServerConnection.PING_INTERVAL = PING_INTERVAL;
CnCServerConnection.PING_TIMEOUT = PING_TIMEOUT;
CnCServerConnection.PING_CONSECUTIVE_FAILURE_DROP = PING_CONSECUTIVE_FAILURE_DROP;
Object.freeze(CnCServerConnection);
