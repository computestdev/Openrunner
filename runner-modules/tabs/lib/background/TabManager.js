...
class TabManager extends EventEmitter {
    ...
    async handleTabMainContentInitialized(browserTabId, browserFrameId, contentInstanceToken) {
        const tab = this.myTabs.getByBrowserTabId(browserTabId);
        ...
        const executeContentScript = (initToken, file) => {
            log.debug(
                {browserTabId, browserFrameId, contentInstanceToken, contentId, initToken, file},
